...
public class TrangChuThuThu_QLPM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPK_themPM.setBackground(new java.awt.Color(204, 255, 204));
        ...
        cbbK_maCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbbK_maCBActionPerformed(evt);
            }
        });
        ...
        jPK_themMaSach.setBackground(new java.awt.Color(204, 255, 204));
        ...
        jPK_btnQLPM.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnK_themPM.setBackground(new java.awt.Color(255, 204, 255));
        ...
        btnK_suaPM.setBackground(new java.awt.Color(255, 204, 255));
        ...
        btnK_lamMoiPM.setBackground(new java.awt.Color(255, 204, 255));
        btnK_lamMoiPM.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        btnK_lamMoiPM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/nhapmoi.png"))); // NOI18N
        ...
        btnK_luuPM.setBackground(new java.awt.Color(255, 204, 255));
        ...
        jPK_btnQLS.setBackground(new java.awt.Color(204, 255, 255));
        ...
        btnK_themMaSach.setBackground(new java.awt.Color(255, 204, 255));
        ...
        btnK_lamMoiSach.setBackground(new java.awt.Color(255, 204, 255));
        btnK_lamMoiSach.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        btnK_lamMoiSach.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/nhapmoi.png"))); // NOI18N
        ...
        btnK_xoaMaSach.setBackground(new java.awt.Color(255, 204, 255));
        ...
        btnK_luuMaSach.setBackground(new java.awt.Color(255, 204, 255));
        ...
        jPK_buttonLayout.setHorizontalGroup(
            ...
            .addGroup(jPK_buttonLayout.createSequentialGroup()
                .addComponent(jPK_btnQLPM, javax.swing.GroupLayout.DEFAULT_SIZE, 743, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if(txtK_maPM_1.getText().compareTo("")==0) {
            if(txtK_maTK.getText().equals("") || new java.sql.Date(txtK_ngayMuon.getDate().getTime()).toString().equals("")) {
                ...
                if(checkSoLuongMuon(txtK_maTK.getText())==true) {
                    ...
                    pm.setMaDocGia(txtK_maTK.getText());
                    pm.setMaThuThu(cbbK_maCB.getSelectedItem().toString());
            ...
            pm1.setMaThuThu(cbbK_maCB.getSelectedItem().toString());
...
//        loadData_TblCTPM();
    ...
    private void cbbK_maCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbbK_maCBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbbK_maCBActionPerformed
    ...
    private void setTableData_DSPM(List<PhieuMuon> pms) {
        for(PhieuMuon pm : pms) {
            defaultTableModel.addRow(new Object[] {pm.getMaPM(), pm.getMaDocGia(), pm.getMaThuthu(),
    ...
    private void loadData_TblDSPM() {
        ...
        defaultTableModel.addColumn("Mã thủ thư");
    ...
    private void load_MaCB() {
        ...
        String sql = "SELECT maThuthu FROM Thuthu";
        try{
            Statement statement = conn.createStatement();
            ResultSet rs = statement.executeQuery(sql);
            while(rs.next()){
                this.cbbK_maCB.addItem(rs.getString("maThuthu"));
            }
        }catch(Exception e){
    ...
    private void loadMaCBwithName(String name) {
        String sql = "SELECT maThuthu FROM Thuthu WHERE tenThuthu like N'%" + name + "%'";
        try{
            Statement statement = conn.createStatement();
            ResultSet rs = statement.executeQuery(sql);
            while(rs.next()){
